...
echo "<form action=signup_process.php method=post id='signupform'>";
    echo "<table>";
        ...
        echo "<tr>";
            ...
            echo "</td>";
            echo "<td>";
                echo "<input type=text name=p_telnumber size=20 maxlength=10>";
            echo "</td>";
        echo "</tr>";
        ...
        echo "<tr>";
            ...
            echo "</td>";
            echo "<td>";
                echo "<input type=password name=p_password size=20 maxlength=100>";
            echo "</td>";
        echo "</tr>";
        ...
        echo "<tr>";
            ...
            echo "</td>";
            echo "<td>";
                echo "<input type=password name=p_confirm_password size=20 maxlength=100>";
            echo "</td>";
        echo "</tr>";
        ...
        echo "<tr>";
            ...
            echo "</td>";
            echo "<td>";
                echo "<input type=reset name='resetbtn' value='CLEAR FORM' id='resetbtn'>";
            echo "</td>";
        echo "</tr>";
